  ...
  return (
    <div className="flex flex-1 flex-col gap-4">
      ...
      <form className="flex flex-1 flex-col gap-2">
        ...
        <textarea name="content" spellCheck={false} placeholder="Feel free to add pictures, videos and details about the experience you want to remember forever" className="w-full flex-1 resize-none rounded border-0 bg-transparent p-0 text-lg leading-relaxed text-gray-100 placeholder:text-gray-400 focus:ring-0" />
      </form>
    </div>
  );
}